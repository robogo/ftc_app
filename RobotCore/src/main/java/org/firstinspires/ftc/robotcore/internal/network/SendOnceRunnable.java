...
import org.firstinspires.ftc.robotcore.internal.RobotCoreGamepadManager;
...
public class SendOnceRunnable implements Runnable {
    ...
    public static class Parameters {
        ...
        public boolean                 originateHeartbeats = AppUtil.getInstance().getThisApp().isDriverStation();
